...
class User:
    ...
    stops: Dict[int, Stop]  # stopID, Stop
...
class CryptoTrader:
    ...
    # sets stop on user, and call self._setUser(user) when done
    def set_stop(
        self,
        user_name: str,
        ticker: str,
    ...
    # updates stopId on user, and call self._setUser(user) when done
    def update_stop(
        self,
        user_name: str,
        stop_id: int,
    ...
    # deletes stop from user, and calls self._setUser(user) when done
    def delete_stop(
        self,
        user_name,
        stop_id: int
    ...
    # for every stop for every user:
    #   - check if stop condition is met
    #   - calls self._setUser(user) if stops / portolio changes
    #   - sends user a message if stop has been executed
    def execute_stops(self) -> None:
        pass  # TODO: implement
